...
CREATE TABLE `t_admin` (
  ...
  `telephone` varchar(16) CHARACTER SET utf8 DEFAULT NULL COMMENT '住宅电话',
  `address` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT '联系地址',
  ...
  `userFace` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '用户头像',
...
-- Records of t_admin
-- ----------------------------
INSERT INTO `t_admin` VALUES ('1', '系统管理员', '13812361398', '71937538', '香港特别行政区强县长寿柳州路p座123', '1', 'admin', '$2a$10$ogvUqZZAxrBwrmVI/e7.SuFYyx8my8d.9zJ6bs9lPKWvbD9eefyCe', 'https://img0.baidu.com/it/u=2835452565,1479648267&fm=253&fmt=auto&app=138&f=JPEG?w=636&h=500', null);
INSERT INTO `t_admin` VALUES ('2', '何淑华', '18875971675', '41413109', '河北省秀荣市萧山长沙街p座 737268', '1', 'taomeng', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://img1.baidu.com/it/u=2377591293,2407777995&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500', null);
INSERT INTO `t_admin` VALUES ('3', '安淑华123', '14588110811', '50603155', '山东省凤英县长寿银川街l座', '1', 'naqiao', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://img1.baidu.com/it/u=2363162627,3400111259&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=666', null);
INSERT INTO `t_admin` VALUES ('4', '林宇', '15761248727', '25546253', '宁夏回族自治区帆市翔安昆明路b座 672985', '0', 'leisu', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://img0.baidu.com/it/u=2746214125,2020470115&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=753', null);
INSERT INTO `t_admin` VALUES ('5', '武军', '18030710396', '27523842', '宁夏回族自治区秀兰县涪城邯郸路t座 618651', '0', 'hanli', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://img2.baidu.com/it/u=669234467,2024098443&fm=253&fmt=auto&app=138&f=JPEG?w=471&h=500', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPACT;
...
INSERT INTO `t_admin_role` VALUES ('16', '1', '1');
INSERT INTO `t_admin_role` VALUES ('55', '3', '3');
INSERT INTO `t_admin_role` VALUES ('56', '3', '4');
INSERT INTO `t_admin_role` VALUES ('77', '2', '3');
...
CREATE TABLE `t_department` (
  ...
  `dep_path` varchar(255) DEFAULT NULL COMMENT '路径',
  `enabled` tinyint(1) DEFAULT '1' COMMENT '是否启用',
...
-- ----------------------------
INSERT INTO `t_department` VALUES ('1', '股东会', '-1', '.1', '1', '0');
INSERT INTO `t_department` VALUES ('2', '董事会', '1', '.1.2', '1', '0');
...
INSERT INTO `t_department` VALUES ('14', '开发部门', '12', '.1.2.3.12.14', '1', '1');
INSERT INTO `t_department` VALUES ('15', '前端开发', '14', '.1.2.3.12.14.15', '1', '0');
INSERT INTO `t_department` VALUES ('18', '后端开发', '14', '.1.2.3.12.14.18', '1', '0');
INSERT INTO `t_department` VALUES ('29', '', '0', null, '1', '0');
INSERT INTO `t_department` VALUES ('37', '测试', '14', '.1.2.3.12.14.37', '1', '0');
INSERT INTO `t_department` VALUES ('38', '。。', '14', '.1.2.3.12.14.38', '1', '0');
INSERT INTO `t_department` VALUES ('39', '99', '14', '.1.2.3.12.14.39', '1', '0');
INSERT INTO `t_department` VALUES ('40', '44', '14', '.1.2.3.12.14.40', '1', '0');
...
CREATE TABLE `t_employee` (
  ...
  `name` varchar(10) CHARACTER SET utf8 DEFAULT NULL COMMENT '员工姓名',
  `gender` char(4) CHARACTER SET utf8 DEFAULT NULL COMMENT '性别',
  `birthday` date DEFAULT NULL COMMENT '出生日期',
  `id_card` char(18) CHARACTER SET utf8 DEFAULT NULL COMMENT '身份证号',
  `wedlock` enum('已婚','未婚','离异') CHARACTER SET utf8 DEFAULT NULL COMMENT '婚姻状况',
  `nation_id` int(8) DEFAULT NULL COMMENT '民族',
  `native_place` varchar(20) CHARACTER SET utf8 DEFAULT NULL COMMENT '籍贯',
  `politic_id` int(8) DEFAULT NULL COMMENT '政治面貌',
  `email` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT '邮箱',
  `phone` varchar(11) CHARACTER SET utf8 DEFAULT NULL COMMENT '电话号码',
  `address` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT '联系地址',
  ...
  `engage_form` varchar(8) CHARACTER SET utf8 DEFAULT NULL COMMENT '聘用形式',
  `tiptop_degree` enum('博士','硕士','本科','大专','高中','初中','小学','其他') CHARACTER SET utf8 DEFAULT NULL COMMENT '最高学历',
  `specialty` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '所属专业',
  `school` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '毕业院校',
  `begin_date` date DEFAULT NULL COMMENT '入职日期',
  `work_state` enum('在职','离职') CHARACTER SET utf8 DEFAULT '在职' COMMENT '在职状态',
  `work_id` char(8) CHARACTER SET utf8 DEFAULT NULL COMMENT '工号',
  ...
  `salary_id` int(11) DEFAULT NULL COMMENT '工资账套ID',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `departmentId` (`department_id`) USING BTREE,
  KEY `jobId` (`job_level_id`) USING BTREE,
  ...
  KEY `salaryId` (`salary_id`) USING BTREE,
  CONSTRAINT `t_employee_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `t_department` (`id`),
  CONSTRAINT `t_employee_ibfk_2` FOREIGN KEY (`job_level_id`) REFERENCES `t_joblevel` (`id`),
  CONSTRAINT `t_employee_ibfk_3` FOREIGN KEY (`pos_id`) REFERENCES `t_position` (`id`),
  CONSTRAINT `t_employee_ibfk_4` FOREIGN KEY (`nation_id`) REFERENCES `t_nation` (`id`),
  CONSTRAINT `t_employee_ibfk_5` FOREIGN KEY (`politic_id`) REFERENCES `t_politics_status` (`id`),
  CONSTRAINT `t_employee_ibfk_6` FOREIGN KEY (`salary_id`) REFERENCES `t_salary` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of t_employee
-- ----------------------------
INSERT INTO `t_employee` VALUES ('1', '韦梅', '女', '1999-11-20', '341502198810196427', '离异', '1', '英市', '11', 'xia53@gangjing.cn', '15567487644', '贵州省洁市清城汕尾街d座 502246', '3', '5', '2', '劳动合同', '博士', '电子工程', '中国科学技术大学', '2018-10-16', '在职', '00000001', '9.31', '2018-08-29', null, '2017-09-03', '2019-08-26', null, '4');
...
INSERT INTO `t_employee` VALUES ('101', '文阳阳', '男', '2002-10-01', '322080200210014532', '未婚', '1', '汉族', '1', '2511437719@qq.com', '18800290017', '18800290017', '2', '7', '1', '劳动合同', '博士', '行政管理', '湖北大学', '2021-08-06', '在职', '00000101', '2.99', '2022-03-03', null, '2021-08-06', '2024-08-01', null, null);
INSERT INTO `t_employee` VALUES ('102', '文阳阳', '男', '2002-10-01', '322080200210014532', '未婚', '1', '汉族', '1', '2511437719@qq.com', '18800290017', '18800290017', '2', '7', '1', '劳动合同', '博士', '行政管理', '湖北大学', '2021-08-06', '在职', '00000101', '2.99', '2022-03-03', null, '2021-08-06', '2024-08-01', null, null);
INSERT INTO `t_employee` VALUES ('103', '文阳阳', '男', '2002-10-01', '322080200210014532', '未婚', '1', '汉族', '1', '2511437719@qq.com', '18800290017', '18800290017', '2', '7', '1', '劳动合同', '博士', '行政管理', '湖北大学', '2021-08-06', '在职', '00000101', '2.99', '2022-03-03', null, '2021-08-06', '2024-08-01', null, null);
INSERT INTO `t_employee` VALUES ('104', '文阳阳', '男', '2002-10-01', '322080200210014532', '未婚', '1', '汉族', '1', '2511437719@qq.com', '18800290017', '18800290017', '2', '7', '1', '劳动合同', '博士', '行政管理', '湖北大学', '2021-08-06', '在职', '00000101', '2.99', '2022-03-03', null, '2021-08-06', '2024-08-01', null, null);
INSERT INTO `t_employee` VALUES ('105', '文阳阳', '男', '2002-10-01', '322080200210014532', '未婚', '1', '汉族', '1', '2511437719@qq.com', '18800290017', '18800290017', '2', '7', '1', '劳动合同', '博士', '行政管理', '湖北大学', '2021-08-06', '在职', '00000101', '2.99', '2022-03-03', null, '2021-08-06', '2024-08-01', null, null);
INSERT INTO `t_employee` VALUES ('106', '文阳阳', '男', '2002-10-01', '322080200210014532', '未婚', '1', '汉族', '1', '2511437719@qq.com', '18800290017', '18800290017', '2', '7', '1', '劳动合同', '博士', '行政管理', '湖北大学', '2021-08-06', '在职', '00000101', '2.99', '2022-03-03', null, '2021-08-06', '2024-08-01', null, null);
INSERT INTO `t_employee` VALUES ('107', '阳阳', '男', '2020-01-01', '41302620010909454X', '未婚', '3', 's', '1', '2511890018@qq.com', '18800980098', '1', '2', '4', '4', '劳动合同', '初中', 's', 's', '2022-08-01', '在职', '00000102', '0', '2022-08-25', null, '2022-08-29', '2022-08-29', null, null);
INSERT INTO `t_employee` VALUES ('108', '阳阳', '男', '2020-01-01', '41302620010909454X', '未婚', '3', 's', '1', '2511890018@qq.com', '18800980098', '1', '2', '4', '4', '劳动合同', '初中', 's', 's', '2022-08-01', '在职', '00000102', '0', '2022-08-25', null, '2022-08-29', '2022-08-29', null, null);
INSERT INTO `t_employee` VALUES ('109', '阳阳', '男', '2020-01-01', '41302620010909454X', '未婚', '3', 's', '1', '2511890018@qq.com', '18800980098', '1', '2', '4', '4', '劳动合同', '初中', 's', 's', '2022-08-01', '在职', '00000102', '0', '2022-08-25', null, '2022-08-29', '2022-08-29', null, null);
INSERT INTO `t_employee` VALUES ('110', '阳阳', '男', '2020-01-01', '41302620010909454X', '未婚', '3', 's', '1', '2511890018@qq.com', '18800980098', '1', '2', '4', '4', '劳动合同', '初中', 's', 's', '2022-08-01', '在职', '00000102', '0', '2022-08-25', null, '2022-08-29', '2022-08-29', null, null);
INSERT INTO `t_employee` VALUES ('111', '阳阳', '男', '2020-01-01', '41302620010909454X', '未婚', '3', 's', '1', '2511890018@qq.com', '18800980098', '1', '2', '4', '4', '劳动合同', '初中', 's', 's', '2022-08-01', '在职', '00000102', '0', '2022-08-25', null, '2022-08-29', '2022-08-29', null, null);
INSERT INTO `t_employee` VALUES ('112', '阳阳', '男', '2020-01-01', '41302620010909454X', '未婚', '3', 's', '1', '2511890018@qq.com', '18800980098', '1', '2', '4', '4', '劳动合同', '初中', 's', 's', '2022-08-01', '在职', '00000102', '0', '2022-08-25', null, '2022-08-29', '2022-08-29', null, null);
...
CREATE TABLE `t_joblevel` (
  ...
  `title_level` enum('正高级','副高级','中级','初级','员级') DEFAULT NULL COMMENT '职称等级',
...
INSERT INTO `t_joblevel` VALUES ('2', '副教授', '副高级', '2022-07-18 21:59:15', '1');
...
INSERT INTO `t_joblevel` VALUES ('9', '初级测试工程师', '初级', '2022-07-18 21:51:56', '1');
...
CREATE TABLE `t_mail_log` (
  `msg_id` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '消息id',
  `eid` int(11) DEFAULT NULL COMMENT '接收员工id',
  `status` int(1) DEFAULT NULL COMMENT '状态（0:消息投递中 1:投递成功 2:投递失败）',
  `route_key` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '路由键',
  `exchange` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '交换机',
  `count` int(1) DEFAULT NULL COMMENT '重试次数',
  `try_time` datetime DEFAULT NULL COMMENT '重试时间',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  UNIQUE KEY `msgId` (`msg_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of t_mail_log
-- ----------------------------
INSERT INTO `t_mail_log` VALUES ('170c94eb-972a-4f10-a012-9c55062fa687', '108', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:09:55', '2022-08-06 00:08:55', '2022-08-06 00:08:55');
INSERT INTO `t_mail_log` VALUES ('1d2aedfd-22e7-4e31-b3ac-d09eca85377e', '104', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:04:52', '2022-08-06 00:03:52', '2022-08-06 00:03:52');
INSERT INTO `t_mail_log` VALUES ('46b03c80-bb2c-4160-8686-f86dff9c9579', '112', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:13:11', '2022-08-06 00:12:11', '2022-08-06 00:12:11');
INSERT INTO `t_mail_log` VALUES ('5fa22169-feb7-4311-9b8f-21e844481f15', '105', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:04:52', '2022-08-06 00:03:52', '2022-08-06 00:03:52');
INSERT INTO `t_mail_log` VALUES ('7561786a-1d6a-4e58-872c-8c82147095c1', '106', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:05:19', '2022-08-06 00:04:19', '2022-08-06 00:04:19');
INSERT INTO `t_mail_log` VALUES ('ad5a4e77-3c58-4d87-8399-ef904ba9e299', '111', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:11:47', '2022-08-06 00:10:47', '2022-08-06 00:10:47');
INSERT INTO `t_mail_log` VALUES ('b8367d7e-9bdc-4adb-982e-ec4acfa4019f', '110', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:10:48', '2022-08-06 00:09:48', '2022-08-06 00:09:48');
INSERT INTO `t_mail_log` VALUES ('f7030c18-1209-4efa-a0bc-d6f004929c04', '107', '0', 'mail.routing.key', 'mail.exchange', '0', '2022-08-06 00:09:14', '2022-08-06 00:08:14', '2022-08-06 00:08:14');
...
CREATE TABLE `t_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `url` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT 'url',
  `path` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT 'path',
  `component` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT '组件',
  `name` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT '菜单名',
  `iconCls` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT '图标',
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=375 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
INSERT INTO `t_menu_role` VALUES ('351', '7', '6');
INSERT INTO `t_menu_role` VALUES ('352', '8', '6');
INSERT INTO `t_menu_role` VALUES ('353', '7', '8');
INSERT INTO `t_menu_role` VALUES ('354', '8', '8');
INSERT INTO `t_menu_role` VALUES ('355', '9', '8');
INSERT INTO `t_menu_role` VALUES ('356', '10', '8');
INSERT INTO `t_menu_role` VALUES ('357', '11', '8');
INSERT INTO `t_menu_role` VALUES ('358', '12', '8');
INSERT INTO `t_menu_role` VALUES ('359', '13', '8');
INSERT INTO `t_menu_role` VALUES ('360', '14', '8');
INSERT INTO `t_menu_role` VALUES ('361', '15', '8');
INSERT INTO `t_menu_role` VALUES ('362', '16', '8');
INSERT INTO `t_menu_role` VALUES ('363', '17', '8');
INSERT INTO `t_menu_role` VALUES ('364', '18', '8');
INSERT INTO `t_menu_role` VALUES ('365', '19', '8');
INSERT INTO `t_menu_role` VALUES ('366', '20', '8');
INSERT INTO `t_menu_role` VALUES ('367', '21', '8');
INSERT INTO `t_menu_role` VALUES ('368', '22', '8');
INSERT INTO `t_menu_role` VALUES ('369', '23', '8');
INSERT INTO `t_menu_role` VALUES ('370', '24', '8');
INSERT INTO `t_menu_role` VALUES ('371', '25', '8');
INSERT INTO `t_menu_role` VALUES ('372', '26', '8');
INSERT INTO `t_menu_role` VALUES ('373', '27', '8');
INSERT INTO `t_menu_role` VALUES ('374', '28', '8');
...
CREATE TABLE `t_position` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '职位',
  `create_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `enabled` tinyint(1) DEFAULT '1' COMMENT '是否启用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `name` (`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=COMPACT;
...
INSERT INTO `t_position` VALUES ('6', '', '2022-07-16 17:24:02', '0');
INSERT INTO `t_position` VALUES ('7', '测试开发工程师', '2022-07-17 16:03:23', '1');
...
INSERT INTO `t_role` VALUES ('9', 'ROLE_businissManage', '业务经理');
...
-- Records of t_salary
-- ----------------------------
INSERT INTO `t_salary` VALUES ('1', '8200', '500', '800', '400', null, '1000', '0.06', '2018-01-24 00:00:00', '1000', '0.06', '1000', '0.06', '市场部工资账套');
...
INSERT INTO `t_salary` VALUES ('5', '10000', '1000', '200', '200', null, '13000', '0.08', '2022-08-06 12:58:13', '13000', '0.09', '12000', '0.9', '企划部工资账套');
